# Spinazie (spinazie) — nl_2773 (productie), nl_2774 (zaad en vermeerderingsmateriaal)

Spinazie is een kortcyclisch (35–55 dagen) bladgewas, bijna altijd op contract geteeld voor
verwerkers. De combinatie van korte cyclus + bladconsumptie maakt **N-management dominant**:
...
- Ammonium- of gemengde vormen (KAS, ammoniumsulfaatsalpeter) op koude gronden in het voorjaar —
  beperkt uitspoeling vóór gewasopname.
- S volgens `advice.d_s_req` — spinazie heeft een matige S-behoefte.
- K als K₂SO₄ wanneer chloridevrij een contractvoordeel is; anders is KCl acceptabel.
...
- Op percelen met late oogst (late zomer / herfst) kan laat toegediende N zich bij koel weer
  ophopen als nitraat — begrens de gift bewust, zelfs als `advice.d_n_req` meer toestaat.
- Snijspinazie die opnieuw uitloopt (meerdere sneden) volgt hetzelfde principe; een N-gift na
  elke snede is acceptabel, mits deze vóór de N-vrije periode van de laatste oogst ligt.
