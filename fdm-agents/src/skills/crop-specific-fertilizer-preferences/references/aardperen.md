...
gevoelig voor de meeste akkerbouwziekten, en heeft een lage tot matige meststofbehoefte.

> **Catalogusopmerking**: nl_2651 is de oudere code "voederbieten (inclusief aardperen)"
> die voederbieten en aardperen samenvoegt. Wanneer het perceel feitelijk
> aardperen betreft, gebruik dan **nl_1949** en de regels hieronder. De suiker-/voederbietenregels in
...
- Lage tot matige N: aardperen zijn N-efficiënt en gevoelig voor legering bij hoge N. Volg
  ...
  voldoende.
- K en P volgens `advice.d_k_req` / `advice.d_p_req` — knolvorming vraagt voldoende K.
- KCl is acceptabel — geen chloridegevoeligheid.
- Goed uitgerijpte organische stof toegediend in het voorjaar of de voorafgaande herfst. Aardperen
...
- **Opslag / onkruidproblemen in volggewassen**: aardperen zijn extreem persistent —
  ...
  veel akkerbouwers deze persistentie onderschatten.
- N-vrijkoming uit gewasresten: matig (aanzienlijke hoeveelheid loof- en knolresten); neem
  dit mee in de N-planning voor volgend jaar.
- Aardperen worden soms geteeld voor energie / biogas; de bemestingsregels veranderen niet,
  en `advice.d_n_req` houdt rekening met de bestemming.
