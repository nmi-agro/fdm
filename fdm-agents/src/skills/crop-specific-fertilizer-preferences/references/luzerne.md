...
- Voldoende aanvoer van K, S en (beperkt) Ca/B voor een productief gewas: volg
  `advice.d_k_req`, `advice.d_s_req`, `advice.d_b_req`, `advice.d_ca_req`. Luzerne heeft een
  hoge K- en S-behoefte.
- Patentkali (K₂SO₄·MgSO₄) als aantrekkelijke K + Mg + S-combinatie, vooral op lichtere
  gronden.
- Bekalking bij een lage bodem-pH: luzerne is een van de meest pH-gevoelige akkerbouwgewassen
  in NL (beworteling en Rhizobium-activiteit nemen sterk af op zure gronden). Behandel een
  lage pH-KCl als een sterk risicosignaal en raadpleeg `advice.d_ca_req`.
- Borium: luzerne is zeer B-gevoelig (groeistoornissen, slechte hergroei). Raadpleeg
  `advice.d_b_req`.
...
- Cl-tolerantie: luzerne is matig Cl-tolerant; KCl is acceptabel wanneer bodem-K de beperkende
  factor is en Mg anderszins is gedekt, maar K₂SO₄ / patentkali heeft de voorkeur voor
  gecombineerde K + S-aanvoer.
