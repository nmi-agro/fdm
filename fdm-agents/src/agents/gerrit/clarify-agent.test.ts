...
import { CLARIFY_INSTRUCTION, CLARIFY_NAME, createClarifyAgent } from "./clarify-agent"
import { ClarificationAnswerSchema, ClarifyingQuestionsSchema } from "./clarify-schema"
...
vi.mock("../../tools/fertilizer-planner", () => ({
  ...
  createClarifyAgentTools: vi
    .fn()
    .mockReturnValue([{ name: "getFarmFields" }, { name: "searchFertilizers" }]),
}))
