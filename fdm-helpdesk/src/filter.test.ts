...
import { addAdminAgent, addAgent, getAgents, setAgentActiveStatus } from "./agent"
...
describe("getAgentWhereClause", () => {
  ...
  test("should return only active agents when isActive is true", async ({ fdm }) => {
  ...
  test("should return only inactive agents when isActive is false", async ({ fdm }) => {
    await setAgentActiveStatus(fdm, admin_id, agent_id, false)
  ...
  test("should return all agents when no activity filter is applied", async ({ fdm }) => {
    await setAgentActiveStatus(fdm, admin_id, agent_id, false)
...
describe("getMessageWhereClause", () => {
  ...
  test("should return only public messages when isInternal is false", async ({ fdm }) => {
  ...
  test("should return only internal messages when isInternal is true", async ({ fdm }) => {
    await addMessage(fdm, ticket_id, admin_id, "agent", "Public message", false)
    await addMessage(fdm, ticket_id, admin_id, "agent", "Internal message", true)
