...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Bekijk de BLN3 bodemkwaliteitsindicatoren voor je percelen en bedrijf.",
    },
  ]
}
...
export default function IndicatorsLayout() {
  ...
  const action = b_id
    ? {
        to: `/farm/${loaderData.b_id_farm}/${loaderData.calendar}/indicators`,
        label: "Terug naar indicatoren",
        disabled: false,
      }
    : {
