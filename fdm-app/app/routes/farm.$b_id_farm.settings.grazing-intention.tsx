...
export async function loader({ request, params }: LoaderFunctionArgs) {
  try {
    ...
    const grazingIntentions = await getGrazingIntentions(fdm, session.principal_id, b_id_farm)
                  ...
                  <TableRow key={year}>
                    ...
                    <TableCell>
                      {farmWritePermission ? (
                          ...
                          <Switch
                            ...
                            onCheckedChange={() => {
                              void fetcher.submit(
                                {
                                  year: String(year),
                                  hasGrazingIntention: String(hasGrazingIntention),
                                },
                                {
                                  method: "post",
                                },
                        ...
                        <Switch checked={hasGrazingIntention} />
                      )}
                    </TableCell>
                  </TableRow>
                )
