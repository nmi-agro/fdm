        ...
        return (
            <Empty>
                ...
                <EmptyDescription className="text-muted-foreground">
                    Selecteer een ticket uit de lijst om het te bekijken of te
                    beantwoorden.
                </EmptyDescription>
            </Empty>
        )
    ...
    return (
        <Empty>
            <EmptyContent>
                ...
                <EmptyDescription>
                    Hier ziet u alle tickets die u heeft aangemaakt. Selecteer
                    een ticket om het gesprek te bekijken of te vervolgen.
                </EmptyDescription>
