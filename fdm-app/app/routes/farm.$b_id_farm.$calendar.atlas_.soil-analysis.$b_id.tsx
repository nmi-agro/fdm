...
export default function AtlasSoilAnalysisFieldDetailLayout() {
  const { b_id_farm, calendar, b_id, farmOptions, fieldOptions } = useLoaderData<typeof loader>()
  ...
  return (
    <SidebarInset>
      <Header action={action}>
        ...
        <HeaderField b_id_farm={b_id_farm} b_id={b_id} fieldOptions={fieldOptions} compact />
      </Header>
      <main className="p-6">
        <Outlet />
