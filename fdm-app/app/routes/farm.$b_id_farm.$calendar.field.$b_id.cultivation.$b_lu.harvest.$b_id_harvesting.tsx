...
export default function FarmFieldsOverviewBlock() {
  ...
  return (
    <HarvestFormDialog
      ...
      b_lu_yield_bruto={loaderData.harvestableAnalysis.b_lu_yield_bruto ?? undefined}
      ...
      b_lu_n_harvestable={loaderData.harvestableAnalysis.b_lu_n_harvestable ?? undefined}
