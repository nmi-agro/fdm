...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Voeg een meststof toe om deze te gebruiken op dit bedrijf.",
    },
  ]
}
...
export async function loader({ request, params }: LoaderFunctionArgs) {
  try {
    ...
    const returnUrl = requestUrl.searchParams.get("returnUrl") ?? `/farm/${b_id_farm}/fertilizers`
 ...
 */
export default function FarmFertilizerBlock({ params: _params }: Route.ComponentProps) {
