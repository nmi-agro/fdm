                  ...
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      <ol className="list-decimal list-inside space-y-2">
                        ...
                        <li>
                          Klik op de datum om het juiste jaar en de juiste peildatum in te stellen
                          waarvoor u de gecombineerde opgave wilt downloaden.
                        </li>
                        <li>
                          Klik op het zwarte/blauwe pijltje dat naar beneden wijst. Vervolgens
                          verschijnt er een klein uitklapmenu waar "Shape" tussen staat. Klik hierop
