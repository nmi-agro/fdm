...
export async function action({ request, params }: ActionFunctionArgs) {
  try {
    ...
    if (formValues.intent === "invite_user") {
      ...
      await grantRoleToFarm(fdm, principalId, formValues.username, b_id_farm, formValues.role)
    ...
    if (formValues.intent === "remove_user") {
      ...
      if (formValues.invitation_id) {
        ...
        await cancelInvitationForFarm(fdm, principalId, formValues.invitation_id)
