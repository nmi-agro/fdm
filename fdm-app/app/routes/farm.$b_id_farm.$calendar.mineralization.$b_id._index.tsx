import { getCultivations, getCurrentSoilData, getField } from "@nmi-agro/fdm-core"
...
export async function loader({ request, params }: LoaderFunctionArgs) {
  try {
    ...
    const organicMatter = soilData.a_som_loi != null ? Number(soilData.a_som_loi) : undefined
    const soilType = soilData.b_soiltype_agr != null ? String(soilData.b_soiltype_agr) : undefined
    ...
    <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Cumulatieve N-levering (kg N/ha) — vergelijking van MINIP, PMN en Century methoden
          </CardDescription>
        </CardHeader>
        <CardContent>
          <FieldMineralizationChart series={series} year={Number(calendar)} />
        </CardContent>
      </Card>
