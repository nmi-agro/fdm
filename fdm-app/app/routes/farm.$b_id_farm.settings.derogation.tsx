...
export async function action({ request, params }: ActionFunctionArgs) {
  try {
    ...
    if (currentlyHasDerogation) {
      ...
      if (year >= 2026) {
        return dataWithError({}, "Derogatie is niet meer beschikbaar vanaf 2026.")
      }
      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            ...
            Dit heeft invloed op de berekening van je gebruiksruimte.
          </CardDescription>
        </CardHeader>
        <CardContent>
                          ...
                          <Switch
                            ...
                            onCheckedChange={() => {
                              void fetcher.submit(
                                {
                                  year: String(year),
                                  hasDerogation: String(hasDerogation),
                                },
                                {
                                  method: "post",
                                },
