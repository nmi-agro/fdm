...
export const changelogEntries: ChangelogEntry[] = [
  {
    ...
    title: "Maatregeladvies, verbeterde gebruiksruimte en advies per snede",
    description:
      "Bij de BLN3-indicatoren ziet u nu welke maatregelen naar verwachting het meeste effect hebben, zodat de volgorde waarin u maatregelen oppakt onderbouwd is. De stikstofgebruiksnorm neemt voortaan ook volgteelten mee, zijn de  sommige kortingen voor vanggewassen, winterteelten en grasland gecorrigeerd, en bij de stikstofgebruiksnorm is de toelichting, hoe die tot stand is gekomen, verbeterd. Voor grasland is er een bemestingsadvies per snede. Daarnaast krijgt uw bedrijf een geverifieerde status wanneer u percelen ophaalt bij RVO en kunt u een overzicht vinden van de bemestingsplannen voor uw bedrijf.",
    items: [
      "Aanbevolen maatregelen bij de BLN3-indicatoren: Bij de maatregelen en indicatoren ziet u nu welke maatregelen naar verwachting het meeste bijdragen aan een indicator. Op de maatregelenpagina van een perceel staan aanbevelingen bovenaan en kunt u sorteren op impact; in het venster om een maatregel toe te voegen geeft een balkje de verwachte impact weer. Opent u dat venster vanuit een indicator, dan wordt op de impact voor die indicator gesorteerd. Bij elke indicator die niet groen scoort staan aanbevolen maatregelen die u in één klik kunt toevoegen. Op bedrijfsniveau laat de knelpuntenanalyse onder 'Waar te beginnen' zien welke maatregel het meest oplevert voor het hele bedrijf, gewogen naar de oppervlakte van de percelen, en onder de maatregelentabel staan de aanbevelingen gegroepeerd per maatregel met de betreffende percelen erbij. De aanbevelingen worden altijd gecontroleerd tegen de vraag of een maatregel op dat perceel van toepassing is.",
      "Bufferstroken en natuurpercelen buiten BLN3: Bufferstroken, natuurpercelen en andere niet-landbouwkundige percelen tellen niet meer mee bij de BLN3-indicatoren, de maatregelen en de bedrijfsgemiddelden. Deze percelen zijn wel geregistreerd, maar worden niet geteeld; een bodemkwaliteitsscore ervoor zegt weinig en vertekende het beeld van het bedrijf.",
      "Stikstofgebruiksnorm per teelt: De stikstofgebruiksnorm van een perceel is nu de som van de normen van alle teelten die in het kalenderjaar op dat perceel staan, volgens tabel 2 van RVO. Eerder werd uitsluitend gerekend met de hoofdteelt. Voor gewassen die als volgteelt worden geteeld, zoals spinazie, verschillende slasoorten, andijvie en graszaad, wordt de bijbehorende volgteeltnorm gebruikt.",
      "Voorwaarden voor groenbemesters en teelten na maïs: Voor groenbemesters gelden nu de wettelijke voorwaarden: gezaaid vóór 1 september, staand tot ten minste 1 februari van het jaar erna en met een toegestane voorafgaande teelt (granen, koolzaad of graszaad voor de volledige norm; de helft op zand en löss na tijdelijk grasland). Groenbemesters, tijdelijk grasland en vanggewassen die direct op maïs volgen, krijgen geen gebruiksruimte, zoals de regelgeving voorschrijft.",
      "Kortingen bij vanggewassen en winterteelten herzien: De korting op de stikstofgebruiksnorm op zand en löss is op meerdere punten gecorrigeerd. Welke gewassen als vanggewas of als winterteelt gelden, wordt nu per gewas bepaald in plaats van per gewasgroep; hierdoor gelden onder meer snijmaïs en triticale niet langer ten onrechte als winterteelt respectievelijk vanggewas, en bladrammenas-stoppelknollen wél als vanggewas. De beoordeling gaat uit van de hoofdteelt van het voorgaande jaar. Suiker- en voederbieten tellen alleen als winterteelt wanneer ze op of na 1 november zijn geoogst, en korrelmaïs, corncob mix, energiemaïs en suikermaïs alleen wanneer er een vanggewas onder is gezaaid.",
      "Kortingen bij graslandvernieuwing en -vernietiging: De periode voor graslandvernieuwing loopt van 1 juni tot en met 31 augustus. Op klei en veen gold de korting in 2025 alleen voor bedrijven met een derogatievergunning; vanaf 2026 geldt deze op alle grondsoorten. Vindt vernietiging plaats buiten de toegestane periode, dan wordt de korting niet toegepast in plaats van dat de berekening afbreekt. De korting voor vanggewassen en winterteelten en die voor graslandvernieuwing en -vernietiging worden nu bij elkaar opgeteld wanneer beide van toepassing zijn.",
      "Toelichting bij de gebruiksnormen: Op de normenpagina van een perceel staat per norm hoe die is berekend en welke voetnoten en voorwaarden daarbij zijn toegepast, zodat u een uitkomst kunt herleiden. Bemestingen worden daar getoond in de eenheid die bij de meststof hoort. De toelichting over onderdelen van de Meststoffenwet die de applicatie nog niet ondersteunt, staat nu in beeld bovenaan de pagina en is uit te klappen wanneer u die wilt lezen.",
      "Bemestingsadvies per snede voor grasland: Op de adviespagina van een grasperceel staat een kaart 'Advies per snede' met een regel per snede. Per snede wordt de passende snedezwaarte gekozen en volgen het advies en de stikstofvulling die keuze. Voor sneden die al geoogst zijn, wordt de snedezwaarte afgeleid uit de vastgelegde droge-stofopbrengst en ziet u de oogstdatum en de opbrengst in kg ds per hectare. De stikstofvulling per snede wordt getoond voor elk jaar waarin oogsten zijn vastgelegd; in het huidige jaar is de eerstvolgende snede gemarkeerd.",
      "Verbeteringen op de adviespagina van een perceel: Bij de nutriënten staat het verschil met het advies nu in kilogrammen ('-25 kg' of '+35 kg') in plaats van als percentage. Voor sporenelementen worden twee decimalen getoond, bij een advies van nul ziet u het overschot, en voor een nutriënt zonder bemestingen staat er een knop 'Toevoegen'. Kan het advies niet berekend worden, dan krijgt u een melding op de pagina zelf in plaats van een foutpagina.",
      "Geverifieerde relatie met uw bedrijf: Haalt u uw percelen op bij RVO via eHerkenning, dan wordt vastgelegd dat u aantoonbaar bij dit bedrijf hoort. Uw bedrijf krijgt daarmee een geverifieerde status, en op de pagina Toegang ziet u welke gebruikers een geverifieerde relatie met het bedrijf hebben. Zolang die verificatie geldt, kan het KvK-nummer van het bedrijf niet meer worden gewijzigd, zodat het nummer waarop de verificatie berust niet kan gaan afwijken.",
      "Duidelijkere melding bij het ophalen van percelen bij RVO: Wanneer u niet gemachtigd bent voor het opgegeven KvK-nummer, wordt dat nu als zodanig gemeld in plaats van als een algemene storing.",
      "Bemestingsplan bekijken en bewaren: Een gegenereerd bemestingsplan kunt u nu in de applicatie bekijken voordat u het downloadt. Het plan wordt bewaard en opnieuw opgesteld zodra de onderliggende gegevens zijn gewijzigd, zodat u niet met een verouderde versie werkt.",
      "Bedrijfsdashboard volgt het gekozen jaar: Het aantal percelen, de totale oppervlakte en het bemestingsadvies op het bedrijfsdashboard horen nu bij het jaar dat u heeft geselecteerd, in plaats van bij het huidige kalenderjaar.",
      "'Oogst' bij graszaad: Bij grasgewassen die één keer worden geoogst, zoals graszaad, spreekt de applicatie van 'oogst' in plaats van 'snede'. Graszaden staan nu ook als eenmalig oogstbaar in de gewascatalogus.",
      "Variëteiten alfabetisch gesorteerd: In de bouwplantabel en bij het aanmaken van een bedrijf staan de variëteiten van een gewas alfabetisch gesorteerd, wanneer er variëteiten beschikbaar zijn.",
      "Minteken bij aftrekkende BCS-indicatoren: Plasvorming, Scheuren en Spoorvorming worden nu met een minteken weergegeven op de detailpagina van de BodemConditieScore, in het indicatorenvenster van een perceel en in de invoerwizard. Zo is duidelijk dat deze indicatoren van de totaalscore worden afgetrokken.",
      "Atlas opent in het huidige jaar: De Atlas, de hoogtekaart en de bodemkaart openden vanaf de bedrijvenpagina in het laatst beschikbare kalenderjaar, dat in de toekomst kan liggen. Ze openen nu in het huidige jaar, zodat u niet in een jaar zonder percelen terechtkomt.",
    ],
  },
  {
    version: "v0.35.0",
    date: "30 juli 2026",
    title: "Perceeldashboard, Renure, NLV en een tijdlijn",
    description:
      "Elk perceel heeft nu een dashboard waarop kaart, teelten, bemesting, gebruiksruimte, balansen, bodem, indicatoren en maatregelen bij elkaar staan. Renure is toegevoegd aan de gebruiksruimte en de meststoffen, en op de nieuwe Tijdlijn ziet u alle activiteiten op uw percelen in de tijd. Daarnaast helpt de Teeltassistent bij percelen zonder geregistreerde hoofdteelt, is het stikstofleverend vermogen (NLV) toegevoegd en zijn de bodempagina, het bemestingsadvies en het inloggen op onderdelen verbeterd.",
    items: [
      "Perceeldashboard: Wanneer u een perceel opent, komt u nu op een dashboard in plaats van direct op een onderliggende pagina. Hierop staan de kaart van het perceel, de huidige teelt en de teelthistorie (uit de applicatie en uit de BRP), de bemestingen en het bemestingsadvies, de gebruiksruimte, de stikstof- en organische stofbalans, de bodemparameters, bodemanalyses en BodemConditieScore, de BLN-indicatoren en de maatregelen. Elk onderdeel verwijst door naar de bijbehorende pagina, zodat u vanaf één plek verder kunt.",
      "Renure bij gebruiksruimte en meststoffen: Renure zijn stikstofmeststoffen die uit dierlijke mest zijn teruggewonnen. Vanaf 2026 geldt hiervoor een aparte gebruiksnorm van 80 kg stikstof per hectare, bovenop de norm van 170 kg stikstof per hectare uit dierlijke mest. Voor 2026 en later ziet u deze norm als vierde norm bij de gebruiksruimte; voor eerdere jaren tellen deze meststoffen mee als dierlijke mest, zoals de regelgeving voorschrijft. Aan de standaardcatalogus zijn vier Renure-meststoffen toegevoegd (ammoniumsulfaatoplossing, ammoniumnitraatoplossing, mineralenconcentraat en ammoniumstruviet) en daarnaast ammoniumstruviet en kaliumstruviet zonder Renure-classificatie. Nieuwe meststoffen uit de catalogus worden voortaan ook automatisch beschikbaar gesteld aan bestaande bedrijven; voorheen zagen alleen nieuw aangemaakte bedrijven ze.",
      "Stikstofleverend vermogen (NLV): Het stikstofleverend vermogen van de bodem, de stikstof die vrijkomt uit de organische stof, wordt nu berekend en getoond bij de bodemparameters, op het perceeldashboard, in de percelentabel en als kaartlaag bij de bodemanalyses in de Atlas.",
      "Tijdlijn van uw bedrijf: Op de nieuwe pagina 'Tijdlijn' ziet u in één overzicht wanneer welke teelten, bemestingen, oogsten en bodembemonsteringen op uw percelen hebben plaatsgevonden. U kunt in- en uitzoomen en filteren. Op een telefoon of een smal scherm wordt de tijdlijn getoond als een lijst met gebeurtenissen op datum, met filters op maand en jaar en de mogelijkheid om per perceel te groeperen.",
      "Snellere navigatie naar percelen: Onderaan het onderdeel Bedrijf in de zijbalk staat nu een uitklapbare groep 'Perceel' met de pagina's van het perceel waar u mee bezig bent. Klikt u in de zijbalk op een bedrijfsonderdeel (zoals Kalender, Percelen, Bouwplan, Maatregelen of Meststoffen) terwijl er nog geen bedrijf actief is, bijvoorbeeld op de bedrijvenpagina, dan verschijnt een venster waarin u een bedrijf kiest en gaat u daarna direct naar de gevraagde pagina. Bij 'Kies een perceel' wordt ook gevraagd om welk perceel het gaat en gaat u meteen naar dat perceel.",
      "Teeltassistent bij ontbrekende hoofdteelt: Voor percelen waarvoor u nog geen hoofdteelt heeft vastgelegd, wordt nu een gewas voorgesteld op basis van een schatting uit de BRP. Het voorstel verschijnt op het bedrijfsdashboard, in de perceelslijst, op de perceelpagina en bij het bemestingsadvies. U kunt het voorstel in één stap overnemen, waarbij u het eerst in een venster kunt controleren, of het formulier laten voorinvullen en zelf aanpassen. Zonder hoofdteelt kunnen de gebruiksnormen en het bemestingsadvies niet worden bepaald; deze functie helpt die percelen op te sporen. Wanneer geen schatting beschikbaar is, blijft het voorstel eenvoudigweg achterwege.",
      "Bodemanalyse-PDF later terugkijken: Een PDF van een bodemanalyse die u uploadt wordt nu bewaard. U kunt de oorspronkelijke bodemanalyse daardoor later in de applicatie inzien en downloaden naast de ingelezen waarden, zodat de herkomst van een meetwaarde controleerbaar blijft. Verwijdert u de bodemanalyse, dan wordt ook de PDF verwijderd.",
      "Maatregelen die niet van toepassing zijn: In de lijst met maatregelen kunt u maatregelen die niet of nog niet van toepassing zijn niet meer selecteren. Er wordt bij vermeld waarom een maatregel niet op het perceel van toepassing is. Op bedrijfsniveau ziet u voor hoeveel percelen een maatregel van toepassing is wanneer dat er niet alle zijn.",
      "Bemestingsadvies als tabel: Het bemestingsadvies op bedrijfsniveau is vervangen door een doorzoekbare en sorteerbare tabel met alle percelen en nutriënten naast elkaar. U kunt wisselen tussen weergave per hectare en totalen, ziet de totalen voor het bedrijf, en het is nu duidelijker aangegeven voor welke percelen geen advies berekend kon worden.",
      "Bepaling van de hoofdteelt gelijkgetrokken: De hoofdteelt wordt nu overal in de applicatie bepaald aan de hand van de teelt die het perceel tussen 15 mei en 15 juli in gebruik heeft, zoals de regelgeving voorschrijft. Op sommige plaatsen werd hiervoor eerder gekeken of een teelt op 15 mei actief was, wat tot afwijkende uitkomsten kon leiden.",
      "Profielfoto en organisatielogo: U kunt nu een profielfoto uploaden en organisaties kunnen een logo uploaden. Foto's en logo's kunnen ook weer worden verwijderd, ook wanneer ze eerder via een social login zijn overgenomen.",
      "Inloggen met een code van zes cijfers: De code die u per e-mail ontvangt bij het aanmelden bestaat nu uit zes cijfers in plaats van acht letters en cijfers. Op een telefoon verschijnt daardoor een numeriek toetsenbord en typt u de code sneller in. U kunt nu ook zelf een nieuwe code aanvragen wanneer de eerste niet aankomt. Verder is het aanmeldscherm verbeterd op het gebied van toegankelijkheid en formulering.",
      "Bodempagina overzichtelijker: De tabbladen op de bodempagina van een perceel zijn vervangen door een indeling in twee kolommen. U ziet daardoor tegelijk de meest recente waarde per bodemparameter en de lijst met bodemanalyses.",
      "Percelen en teelten van 2026: In de Atlas zijn de voorlopige percelen van 2026 beschikbaar en zijn de percelen van 2025 definitief geworden. De nieuwe teelten van 2026 zijn opgenomen in de gewascatalogus, met de bijbehorende stikstofgebruiksnormen. Deze wijzigingen zijn eerder deze maand al beschikbaar gesteld.",
      "Vragen per e-mail komen in de helpdesk terecht: Vragen die u per e-mail aan de ondersteuning stelt, worden nu automatisch als ticket aangemaakt en uw antwoorden komen onder hetzelfde ticket te staan in plaats van als een nieuwe vraag. Maakt u later een account aan met hetzelfde e-mailadres, dan vindt u deze eerdere vragen terug in de helpdesk.",
      "Uitnodigingen zichtbaar voor organisatieleden: Leden van een organisatie zien nu ook de openstaande uitnodigingen voor hun organisatie. Kunt u een uitnodiging niet zelf accepteren of weigeren, dan wordt vermeld dat uw beheerder dit kan doen.",
      "Consistente kleuren bij gebruiksnormen en advies: De balken van de gebruiksnormen en van het bemestingsadvies worden nu overal op dezelfde manier gekleurd. Bij gebruiksnormen is de balk groen binnen de norm en rood daarboven; bij het bemestingsadvies oranje onder 90%, groen tussen 90% en 110% en rood boven 110%.",
      "Duidelijker onderscheid bij foutmeldingen: Wanneer een pagina niet bestaat of u er geen toegang toe heeft, ziet u nu een andere pagina dan bij een storing. Zo is beter te zien of het om een vergissing of om een probleem aan onze kant gaat.",
      "Verbeteringen in het overzicht: De bedrijvenpagina en de bedrijfspagina zijn iets overzichtelijker ingedeeld. De pagina met perceelgegevens is intern hernoemd; de naam 'Gegevens' blijft ongewijzigd.",
      "Foutmelding bij het aanmaken van een teelt: Voert u bij een nieuwe teelt een einddatum in die vóór de startdatum ligt, dan ziet u de foutmelding nu direct bij het formulier. Dit werkte eerder alleen bij het aanpassen van een teelt.",
      "Klikken op de hoofdscore bij indicatoren: Het klikken op de hoogste score in de indicatorenboom klapt de onderliggende indicatoren nu weer open en dicht.",
    ],
  },
  {
    version: "v0.32.0",
