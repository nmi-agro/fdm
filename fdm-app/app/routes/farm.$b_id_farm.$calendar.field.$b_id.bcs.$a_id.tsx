  ...
  const deleteButton = loaderData.fieldWritePermission ? (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button type="button" variant="destructive" size="icon" disabled={fetcher.state !== "idle"}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Deze actie kan niet ongedaan worden gemaakt. Alle foto&apos;s en notities worden ook
            verwijderd.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
