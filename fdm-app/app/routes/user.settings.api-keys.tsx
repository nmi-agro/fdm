        ...
        <div className="flex justify-end gap-2">
          {clientConfig.apiUrl && (
            <Button variant="outline" size="sm" asChild>
              <a href={`${clientConfig.apiUrl}/docs`} target="_blank" rel="noopener noreferrer">
          ...
          <Dialog open={createOpen} onOpenChange={setCreateOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Geef de sleutel een beschrijvende naam zodat je hem later herkent.
                </DialogDescription>
              </DialogHeader>
        ...
        <Dialog open={rawKeyOpen} onOpenChange={setRawKeyOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Deze sleutel wordt <strong>slechts één keer</strong> getoond. Sla hem op een veilige
            ...
            <DialogFooter>
              ...
              <Button onClick={() => setRawKeyOpen(false)}>Sluiten</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
                  ...
                  <li key={k.id} className="flex items-center gap-3 py-3">
                    <div className="flex-1 min-w-0 space-y-0.5">
                      {editId === k.id ? (
                        <div className="flex items-center gap-2">
                          <Input
                            ...
                            onKeyDown={(e) => {
                              if (e.key === "Enter") void handleSaveName(k.id)
                              if (e.key === "Escape") {
                                setEditId(null)
                              }
                            }}
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <Badge variant={k.enabled ? "default" : "secondary"} className="text-xs">
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            De sleutel <strong>{k.name ?? k.id}</strong> wordt permanent verwijderd.
                            Alle automatisering die deze sleutel gebruikt, zal stoppen met werken.
