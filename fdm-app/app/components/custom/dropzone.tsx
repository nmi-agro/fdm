...
export type DropzoneProps = {
  ...
  mergeFiles?: (oldFiles: File[], newFiles: File[]) => Promise<File[] | null> | File[] | null
  children?: ReactNode
}
...
export const Dropzone = ({
  ...
  const checkNewFile = (file: File) => {
    ...
    const fileExtensionCheck = !acceptedFileExtensions || acceptedFileExtensions.includes(extension)
    ...
    if (!maxSizeCheck) {
      notify.warning("Een of meerdere bestanden zijn ongeldig of te groot.", {
        id: "file-too-big",
      })
    }
    if (!minSizeCheck) {
      notify.warning("Een of meerdere bestanden zijn ongeldig of te klein.", {
        id: "file-too-small",
      })
    }
