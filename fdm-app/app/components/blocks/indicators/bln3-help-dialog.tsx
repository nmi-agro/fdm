      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="text-muted-foreground space-y-4 text-sm">
          <p>
            ...
            wetenschappelijk onderbouwd systeem om de bodemkwaliteit van landbouwpercelen objectief
            te beoordelen aan de hand van 27 indicatoren.
          </p>
          ...
          <div className="space-y-1.5">
            ...
            <ul className="space-y-1">
              ...
              <li>
                <span className="font-medium text-yellow-600 dark:text-yellow-400">40–69</span> —
                Matig: aandacht gewenst
              </li>
              <li>
                <span className="font-medium text-red-600 dark:text-red-400">&lt; 40</span> —
