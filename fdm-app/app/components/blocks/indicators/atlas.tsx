  ...
  return (
    <div className="relative" style={{ height }}>
      ...
      {hoverInfo && (
        ...
        >
          <p className="font-semibold text-foreground">{hoverInfo.fieldName}</p>
      ...
      <div className="absolute bottom-6 left-2 pointer-events-none z-10 bg-background/90 backdrop-blur-sm rounded-md p-2 shadow-sm text-xs max-w-[200px]">
        {label && <p className="font-medium truncate mb-1.5 text-foreground">{label}</p>}
        <div
        ...
        <div className="flex items-center gap-2">
          <Select value={selectedProperty} onValueChange={setSelectedProperty}>
            ...
            <SelectContent className="max-h-[380px] overflow-y-auto">
              ...
              <SelectSeparator />
              <SelectGroup>
                <SelectLabel className="text-xs text-muted-foreground">Hoofdthema's</SelectLabel>
              ...
              <SelectSeparator />
              <SelectGroup>
                <SelectLabel className="text-xs text-muted-foreground">Waterthema's</SelectLabel>
