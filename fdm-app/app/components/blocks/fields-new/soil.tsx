      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <CardDescription>Bodemgegevens voor dit perceel.</CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
          {isEstimated && (
            <div className="text-muted-foreground flex items-start gap-2 text-sm leading-snug">
              ...
              <p>
                ...
                We proberen deze automatisch aan het juiste perceel te koppelen, maar je kunt dit na
                het uploaden ook zelf controleren en aanpassen.
              </p>
            </div>
          )}
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <Button variant="outline" asChild className="flex-1 sm:flex-none">
              <NavLink to={`../${b_id}/soil/analysis${location.search}`}>
