 ...
 */
export function matchAnalysesToFields(analyses: any[], fields: Field[]): ProcessedAnalysis[] {
  return analyses.map((analysis) => {
    ...
    if (analysisName) {
      const fieldMatch = fields.find((field) => field.b_name.toLowerCase().trim() === analysisName)
