  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      <AlertDialogTrigger asChild>
        <Button variant="destructive" disabled={isSubmitting} type="button">
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Deze actie kan niet ongedaan worden gemaakt. Dit verwijdert het perceel "{fieldName}" en
            alle bijbehorende gegevens, inclusief gewassen, bemestingen, bodemanalyses en oogsten.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
