            ...
            <Controller
                ...
                render={({ field, fieldState }) => (
                    <Field>
                        ...
                        <FieldDescription>
                            De naam die gebruikers kunnen zien.
                        </FieldDescription>
            ...
            <Controller
                ...
                render={({ field, fieldState }) => (
                    <Field>
                        ...
                        <FieldDescription>
                            Wat is je beschikbaarheid op dit moment?
                        </FieldDescription>
                        <RadioGroup
                            value={field.value}
                                ...
                                <FieldLabel htmlFor={statusOnlineId}>
                                    <span>
                                        ...
                                        <span className="text-muted-foreground">
                                            Je bent nu beschikbaar om nieuwe
                                            tickets te behandelen.
                                        </span>
                                    </span>
                                </FieldLabel>
                            </Field>
                            <Field orientation="horizontal">
                                ...
                                <FieldLabel htmlFor={statusAwayId}>
                                    <span>
                                        Even weg:{" "}
                                        <span className="text-muted-foreground">
                                            Je kunt nog geen nieuwe tickets
                                            behandelen maar je bent zo weer
                                            terug.
                                        </span>
                                    </span>
                                </FieldLabel>
                            ...
                            <Field orientation="horizontal">
                                ...
                                <FieldLabel htmlFor={statusOutOfOfficeId}>
                                    <span>
                                        Buiten het kantoor:{" "}
                                        <span className="text-muted-foreground">
                                            Je bent helemaal niet beschikbaar,
                                            en je tickets moeten opnieuw worden
                                            togewezen.
                                        </span>
                                    </span>
                                </FieldLabel>
            ...
            <Controller
                ...
                render={({ field, fieldState }) => (
                    <Field>
                        ...
                        <FieldDescription>
                            Het maximale aantal tickets dat een agent tegelijk
                            kan behandelen als je online bent.
                        </FieldDescription>
                        <Input
                            {...field}
                            placeholder="Geen"
            ...
            <Controller
                ...
                render={({ field, fieldState }) => (
                    <Field>
                        ...
                        <FieldDescription>
                            Dagen in een week dat je beschikbaar bent om tickets
                            te behandelen.
                        </FieldDescription>
