                        ...
                        <Form method="post" onSubmit={form.handleSubmit}>
                            ...
                            >
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Maak een nieuwe opgeslagen reactie aan
                                        die je later kunt gebruiken bij het
                                        beantwoorden van tickets.
                                    </DialogDescription>
                                </DialogHeader>
                                {isInternal && (
                                    <p className="rounded-lg border border-orange-200 dark:border-orange-900/40">
                                        Let op: dit antwoord kan interne
                                        notities bevatten. Zorg ervoor dat u
                                        deze niet meeneemt wanneer u de sjabloon
                                        gebruikt.
                                    </p>
                                )}
                                <Controller
                                    ...
                                    render={({ field, fieldState }) => (
                                        <Field>
                                            ...
                                            <FieldDescription>
                                                Geef een titel voor de sjabloon.
                                            </FieldDescription>
                                            <Input {...field} />
                                            {fieldState.error ? (
                                                <FieldError
                                ...
                                <Controller
                                    ...
                                    render={({ field, fieldState }) => (
                                        <Field>
                                            ...
                                            <FieldDescription>
                                                Je kunt de sjabloon hier
                                                bewerken.
                                                &#123;&#123;customer_name&#125;&#125;,
                                                &#123;&#123;agent_name&#125;&#125;,
                                                &#123;&#123;farm_name&#125;&#125;,
                                                &#123;&#123;ticket_ref&#125;&#125;
                                                kunnen als plaatsaanduidingen
                                                voor de corresponderende waarden
                                                worden gebruikt.
                                            </FieldDescription>
                                            <Textarea {...field} />
                                            {fieldState.error ? (
