...
export function HeaderFarmCreate({ b_name_farm }: { b_name_farm: string | undefined | null }) {
  ...
  return (
    <>
      <BreadcrumbItem className="hidden xl:block">
        <BreadcrumbLink href={"/farm/create"}>Maak een bedrijf</BreadcrumbLink>
      </BreadcrumbItem>
      ...
      {currentPath.match(/fertilizers/) ? (
        <>
          ...
          {currentPath.match(/new/) ? (
            <>
              <BreadcrumbItem className="hidden xl:block">
                <BreadcrumbLink href={searchParams.get("returnUrl") ?? "#"}>
                  Bemesting
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator className="hidden xl:block" />
