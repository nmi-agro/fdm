  ...
  return (
    <>
      ...
      <BreadcrumbItem className="hidden xl:block">
        <BreadcrumbLink href={`/farm/${b_id_farm}/fertilizers`}>Meststoffen</BreadcrumbLink>
      </BreadcrumbItem>
      {fertilizerOptions.length > 0 ? (
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start">
                {fertilizerOptions.map((option) => (
                  <DropdownMenuCheckboxItem checked={p_id === option.p_id} key={option.p_id}>
                    <NavLink
                      to={
                        p_id
                          ? currentPath.replace(p_id, option.p_id)
        ...
        <>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href={`/farm/${b_id_farm}/fertilizers/new`}>
              Nieuwe meststof
            </BreadcrumbLink>
          </BreadcrumbItem>
        </>
