...
export const BCS_GUIDES: IndicatorGuide[] = [
  {
    key: "a_cc_bcs",
    name: "Gewasbedekking",
    description: "Hoeveel van het bodemoppervlak bedekt is met een levend gewas of plantenresten.",
    instructions:
  ...
  },
  {
    ...
    description: "Mate van verdichting, plaatstructuren en doorwortelbaarheid in de ondergrond.",
    instructions:
  ...
  },
  {
    key: "a_ew_bcs",
    name: "Regenwormen",
    description: "Aantal regenwormen in een steekproef van circa 20 x 20 x 20 cm.",
    instructions:
  ...
  },
  {
    key: "a_ss_bcs",
    name: "Bodemstructuur",
    description: "Grootte en stevigheid van kluiten en de stabiliteit van aggregaten.",
    instructions:
  ...
  },
  {
    ...
    description: "Roest-, blauwe of grijze vlekken die wijzen op langdurige natte omstandigheden.",
    instructions:
  ...
  },
  {
    key: "a_p_bcs",
    name: "Plasvorming",
    description: "Hoe vaak water op het oppervlak blijft staan na neerslag.",
    instructions:
  ...
  },
  {
    key: "a_c_bcs",
    name: "Scheuren",
    description: "Mate waarin de toplaag open is gescheurd door uitdroging of structuurproblemen.",
    instructions:
  ...
  },
  {
    key: "a_rt_bcs",
    name: "Spoorvorming",
    description: "Wielsporen, hoefafdrukken of andere indrukkingen aan het oppervlak.",
    instructions:
