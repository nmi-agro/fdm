...
export const PdfTable = ({ children, style }: { children: React.ReactNode; style?: any }) => (
  <View style={[pdfStyles.table, style]}>{children}</View>
)

export const PdfTableHeader = ({ children, style }: { children: React.ReactNode; style?: any }) => (
  <View style={[pdfStyles.tableHeader, style]}>{children}</View>
)

export const PdfTableRow = ({ children, style }: { children: React.ReactNode; style?: any }) => (
