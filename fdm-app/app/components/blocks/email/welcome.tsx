...
export function WelcomeEmail({
  ...
  return (
    ...
    >
      ...
      <Section>
        <Heading as="h2" className="text-black text-[20px] font-normal text-center p-0 my-7.5 mx-0">
        ...
        <table border={0} cellPadding="0" cellSpacing="0" role="presentation" className="w-full">
          <tr>
            <td className="text-black text-[14px] leading-6 align-top pl-4 pr-2 w-6" valign="top">
              &bull;
            </td>
            <td className="text-black text-[14px] leading-6 align-top" valign="top">
          ...
          <tr>
            ...
            <td className="text-black text-[14px] leading-6 align-top pt-2" valign="top">
        ...
        <Text className="text-black text-[16px] font-bold leading-6 mt-6">Samenwerken</Text>
        <Text className="text-black text-[14px] leading-6">
