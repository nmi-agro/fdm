...
export function HarvestsList({
  ...
  const canAddHarvest =
    b_lu_harvestable === "multiple" || (b_lu_harvestable === "once" && harvests.length === 0)
  ...
  if (canAddHarvest) {
    return (
      <Empty>
        <EmptyHeader>
          <EmptyTitle>
            Nog geen {getHarvestTerm(b_lu_croprotation, false, b_lu_harvestable)}
          </EmptyTitle>
          <EmptyDescription>
            Voeg een {getHarvestTerm(b_lu_croprotation, false, b_lu_harvestable)} toe om belangrijke
            gegevens zoals opbrengst, datum en gehaltes bij te houden.
          </EmptyDescription>
        </EmptyHeader>
      </Empty>
    )
  ...
  return (
    <Empty>
      <EmptyHeader>
        ...
        <EmptyDescription>
          Kies een einddatum om aan te geven wanneer dit gewas is beëindigd.
        </EmptyDescription>
      </EmptyHeader>
    </Empty>
  )
