...
export function FertilizerApplicationListDialog({
  ...
  const fieldNameToShow =
    numFields === 1 ? fertilizerApplications.find((apps) => apps.length > 0)?.[0].b_name : undefined
    ...
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl transition-transform duration-1000">
        <DialogHeader>
          ...
          <DialogDescription>Bekijk en beheer de bemestingen met deze meststof.</DialogDescription>
        </DialogHeader>
        {numFertilizerApplications > 0 ? (
          ...
          <Empty>
            <EmptyHeader>
              ...
              <EmptyDescription>
                Sluit dit venster om een nieuwe bemesting toe te voegen.
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        )}
