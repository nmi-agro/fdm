      ...
      {fertilizerApplications.length > 0 ? (
        <ItemGroup>
          {fertilizerApplications.map((application) => {
            ...
            const editable = canModifyFertilizerApplication[application.p_app_id] ?? true
              ...
              <div key={application.p_app_id}>
                ...
                <Item size="sm" variant="default">
                  <ItemContent>
                    ...
                    <ItemDescription>
                      <p>
                        {application.p_app_amount_display !== null &&
                        application.p_app_amount_display !== undefined
                          ? `${application.p_app_amount_display} ${application.p_app_amount_unit}`
                          : application.p_app_amount !== null &&
                              application.p_app_amount !== undefined
                  ...
                  <ItemActions className={cn(!editable ? "invisible" : "")}>
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          ...
                          >
                            {isBusy ? <Spinner /> : <Trash className="size-4" />}
                          </Button>
                        </TooltipTrigger>
                        <TooltipContent>
                          <p>Verwijder</p>
        ...
        <Empty className="col-span-full">
          <EmptyHeader>
            <EmptyTitle>Je hebt nog geen bemesting ingevuld...</EmptyTitle>
            <EmptyDescription>
              Voeg een bemesting toe om gegevens zoals, meststof, hoeveelheid en datum bij te
              houden.
            </EmptyDescription>
          </EmptyHeader>
        </Empty>
