  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        ...
        <CardDescription>Bemesting- en oogstadvies op basis van DYNA</CardDescription>
      </CardHeader>
          ...
          {fertilizingRecommendations ? (
            <dl className="space-y-1.5 text-sm">
              <div className="flex justify-between">
                <dt className="text-muted-foreground">Aanbevolen gift</dt>
                <dd className="font-semibold tabular-nums">
                  {Math.round(fertilizingRecommendations.b_n_recommended)} kg N/ha
                </dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-muted-foreground">Aanbevolen datum</dt>
                <dd className="tabular-nums">
                  {formatDate(fertilizingRecommendations.b_date_recommended)}
                </dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-muted-foreground">Resterende ruimte</dt>
                <dd className="tabular-nums">
        ...
        <div className="space-y-2">
          ...
          {harvestingRecommendation ? (
            <dl className="text-sm">
              <div className="flex justify-between">
                <dt className="text-muted-foreground">Aanbevolen oogstdatum</dt>
                <dd className="tabular-nums">
