  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        ...
        <CardDescription>Stikstof uit mineralisatie en toevoegingen (kg N/ha/jaar)</CardDescription>
      </CardHeader>
      <CardContent>
        <dl className="space-y-2 text-sm">
          {/* Mineralisatie (bodem) */}
          <div className="flex justify-between">
            <dt className="text-muted-foreground">Bodem mineralisatie</dt>
            <dd className="font-medium tabular-nums">{Math.round(mineralisatie)} kg N/ha</dd>
          </div>

          {/* Artificial fertilizer */}
          <div className="flex justify-between">
            <dt className="text-muted-foreground">Kunstmest</dt>
          ...
          {/* Organic fertilizer */}
          <div className="flex justify-between">
            <dt className="text-muted-foreground">Organische mest</dt>
            <dd className="font-medium tabular-nums">
          ...
          {/* Preceding crop */}
          <div className="flex justify-between">
            <dt className="text-muted-foreground">Voorvrucht</dt>
            <dd className="font-medium tabular-nums">
          ...
          {/* Green manure */}
          <div className="flex justify-between">
            <dt className="text-muted-foreground">Groenbemesting</dt>
            <dd className="font-medium tabular-nums">
          ...
          <div className="flex justify-between">
            ...
            <dd
              className={`font-semibold tabular-nums ${
                totalBalance > 0 ? "text-orange-600" : "text-green-600"
              }`}
            >
              {totalBalance > 0 ? "+" : ""}
