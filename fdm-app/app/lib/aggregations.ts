...
export const AGGREGATIONS: Record<AggregationId, AggregationInfo> = {
    S_BLN: {
        ...
        description: "De overkoepelende BLN-bodemkwaliteitsscore voor uw bedrijf of perceel.",
        parent: null,
    ...
    S_BBWP: {
        ...
        description: "Beoordeling van de bodemkwaliteit gerelateerd aan waterbeheer, uitspoeling en afspoeling.",
        parent: null,
    ...
    S_WAT_BLN: {
        id: "S_WAT_BLN",
        name: "Water",
        description: "Beoordeling van de bodemfuncties gerelateerd aan waterberging, grondwateraanvulling en waterkwaliteit.",
        parent: "S_BLN",
    ...
    S_NUT_BLN: {
        ...
        description: "De efficiëntie waarmee de bodem nutriënten (stikstof, fosfaat, kalium) vasthoudt en beschikbaar stelt aan het gewas.",
        parent: "S_BLN",
    ...
    S_PROD_BLN: {
        id: "S_PROD_BLN",
        name: "Productie (OBI)",
        description: "De Open Bodem Index (OBI) score die de biologische, chemische en fysische geschiktheid van de bodem voor gewasproductie samenvat.",
        parent: "S_BLN",
    ...
    S_GW_QUANT_BLN: {
        ...
        description: "Het vermogen van de bodem om regenwater te infiltreren en vast te houden ter aanvulling van het grondwater en bescherming tegen droogte.",
        parent: "S_WAT_BLN",
    ...
    S_GW_QUAL_BLN: {
        ...
        description: "De weerstand van de bodem tegen uitspoeling van stikstof en gewasbeschermingsmiddelen naar het grondwater.",
        parent: "S_WAT_BLN",
        color: "#2563eb", // Blue-600
    },
    S_SW_QUAL_BLN: {
        ...
        description: "De weerstand van de bodem tegen oppervlakkige afspoeling van nutriënten (stikstof, fosfaat) naar het oppervlaktewater.",
        parent: "S_WAT_BLN",
 ...
 */
export function getAggregationIdsForIndicator(indicatorId: string): AggregationId[] {
...
export function getFieldAggregationScore(
    ...
    if (!score || !score.aggregations) return null
    const found = score.aggregations.find((a) => a.aggregation_id === aggId)
    return found && typeof found.score === "number" && !Number.isNaN(found.score)
        ? found.score
        : null
}
