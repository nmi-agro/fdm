...
/**
 * Enforces body size and Content-Type constraints on write requests.
 */
...
/**
 * Counts GeoJSON coordinates recursively and throws an ApiError if the
 * geometry exceeds 10,000 coordinates.
 */
