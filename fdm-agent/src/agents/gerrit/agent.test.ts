...
import { createNutrientManagementAgent } from "./agent"
...
vi.mock("../../tools/nutrient-management", () => ({
    createNutrientManagementTools: vi.fn().mockReturnValue([]),
}))

describe("Gerrit Agent", () => {
    it("should create a Nutrient Management Agent with correct name", () => {
        const mockFdm = {} as any
        const agent = createNutrientManagementAgent(mockFdm, "fake-api-key")
