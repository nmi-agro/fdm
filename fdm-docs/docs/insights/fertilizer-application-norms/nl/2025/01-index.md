...
- **Cultivation Plan for 2024 (the previous year)**:
  - **Main Crop and Catch Crops**: The nitrogen norm can be reduced when the catch crop (`vanggewas`) or winter crop (`winterteelt`) obligation was not met after the previous year's main crop. The calculator therefore reads cultivations from 1 January 2024 onwards.
  - **Sowing and End Dates**: The sowing date of the catch crop determines the size of the reduction, and its end date shows whether it stood until 1 February 2025. For sugar and fodder beet the harvest date decides whether the crop counts as a winter crop at all.
