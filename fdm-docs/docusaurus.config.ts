...
const config: Config = {
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/nmi-agro/fdm/tree/main/fdm-docs/docs/",
        },
        blog: {
          ...
          editUrl: "https://github.com/nmi-agro/fdm/tree/main/fdm-docs/blog/",
          onInlineTags: "warn",
  ...
  plugins: [
    // API reference docs instance — content is generated by `build:api` (typedoc CLI)
    [
