...
- **Broadcasting:** The `broadcasting` application method has been added to the available options for solid manure (_vaste mesten_) and compost, reflecting that these products can be applied by broadcasting in practice.
