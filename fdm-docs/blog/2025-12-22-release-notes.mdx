...
- **Updated Norms & Regulations:** The calculator has been updated to support the Dutch fertilizer application norms for 2026.
  ...
  - **Looking Ahead:** We will be monitoring the political discussions regarding the _gebruiksruimte_ for 2026. As soon as new regulations are officially publicized, we will update the calculator to ensure compliance.
...
- **Precision & Consistency:**
  ...
  - **Nature Terrain:** Adjusted logic for `nl_335` (Nature terrains/heathland) to correctly classify it as non-arable land (_geen bouwland_).
  ...
  - **Catch Crops:** Fixed the calculation for the fertilizer application discount (_korting_) when a catch crop is sown on October 15th.
