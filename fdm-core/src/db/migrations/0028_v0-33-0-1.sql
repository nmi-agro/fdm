...
--> statement-breakpoint
ALTER TABLE "fdm"."measure_adopting" ADD CONSTRAINT "measure_adopting_b_id_fields_b_id_fk" FOREIGN KEY ("b_id") REFERENCES "fdm"."fields"("b_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "fdm"."measure_catalogue_enabling" ADD CONSTRAINT "measure_catalogue_enabling_b_id_farm_farms_b_id_farm_fk" FOREIGN KEY ("b_id_farm") REFERENCES "fdm"."farms"("b_id_farm") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "m_source_idx" ON "fdm"."measures_catalogue" USING btree ("m_source");--> statement-breakpoint
INSERT INTO "fdm"."measure_catalogue_enabling" ("b_id_farm", "m_source")
SELECT "b_id_farm", 'bln' FROM "fdm"."farms";