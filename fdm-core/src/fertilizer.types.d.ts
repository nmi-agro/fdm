...
export interface Fertilizer extends FertilizerCatalogue {
  p_id: string
...
export interface FertilizerParameterDescriptionItem {
  ...
  max?: number
  options?: {
    value: FertilizerType | ApplicationMethods | schema.fertilizersCatalogueTypeSelect["p_type_rvo"]
    label: string
  }[]
}

export type FertilizerParameterDescription = FertilizerParameterDescriptionItem[]
