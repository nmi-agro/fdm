...
export function convertHarvestParameters(
  ...
  switch (b_lu_harvestcat) {
    case "HC010": // Standard
      return convertHarvestParametersForClassHC010(b_lu_yield_fresh, b_lu_dm, b_lu_n_harvestable)
    ...
    case "HC050": // Cereals
      return convertHarvestParametersForClassHC050(b_lu_yield_fresh, b_lu_moist, b_lu_cp)
    default:
...
function convertHarvestParametersForClassHC010(
  ...
  if (b_lu_yield_fresh == null) {
    throw new Error("Missing required parameter for HC010: b_lu_yield_fresh")
  }
  if (b_lu_dm == null) {
    throw new Error("Missing required parameter for HC010: b_lu_dm")
  }
  if (b_lu_n_harvestable == null) {
    throw new Error("Missing required parameter for HC010: b_lu_n_harvestable")
  }
...
function convertHarvestParametersForClassHC020(
  ...
  const b_lu_n_harvestable_calculated = new Decimal(b_lu_cp).dividedBy(6.25).round().toNumber()
...
function convertHarvestParametersForClassHC040(
  ...
  if (b_lu_yield_bruto == null) {
    throw new Error("Missing required parameter for HC040: b_lu_yield_bruto")
  }
  if (b_lu_tarra == null) {
  ...
  if (b_lu_n_harvestable == null) {
    throw new Error("Missing required parameter for HC040: b_lu_n_harvestable")
  }

  // Calculate fresh yield from gross yield and tare
  const b_lu_yield_fresh = new Decimal(100).minus(b_lu_tarra).dividedBy(100).times(b_lu_yield_bruto)
...
function convertHarvestParametersForClassHC041(
  ...
  // Check if the required parameters are present
  if (b_lu_yield_bruto == null) {
    throw new Error("Missing required parameter for HC041: b_lu_yield_bruto")
  }
  if (b_lu_tarra == null) {
  ...
  if (b_lu_n_harvestable == null) {
    throw new Error("Missing required parameter for HC041: b_lu_n_harvestable")
  }
...
function convertHarvestParametersForClassHC042(
  ...
  // Check if the required parameters are present
  if (b_lu_yield_bruto == null) {
    throw new Error("Missing required parameter for HC042: b_lu_yield_bruto")
  }
  if (b_lu_tarra == null) {
  ...
  if (b_lu_n_harvestable == null) {
    throw new Error("Missing required parameter for HC042: b_lu_n_harvestable")
  }
...
function convertHarvestParametersForClassHC050(
  ...
  // Check if the required parameters are present
  if (b_lu_yield_fresh == null) {
    throw new Error("Missing required parameter for HC050: b_lu_yield_fresh")
  }
  if (b_lu_moist == null) {
  ...
  const b_lu_n_harvestable_calculated = new Decimal(b_lu_cp).dividedBy(5.7).round().toNumber()
