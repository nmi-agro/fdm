...
import { collectNL2025InputForNorms, collectNL2025InputForNormsForFarm } from "./input"
...
describe("collectNL2025InputForNorms", () => {
  it("should collect input correctly", async () => {
    ...
    vi.mocked(fdmCore.getCurrentSoilData).mockResolvedValue(mockSoilAnalysis as CurrentSoilData)
...
describe("collectNL2025InputForNormsForFarm", () => {
  ...
  it("should collect farm input correctly", async () => {
    ...
    const timeframe2025Cultivation = {
      start: new Date(2024, 0, 1),
      end: new Date(2025, 11, 31),
    }
