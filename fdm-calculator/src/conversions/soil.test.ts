  ...
  describe("calculateBulkDensity", () => {
    it("should calculate bulk density correctly for sandy soils", () => {
      ...
      for (const soilType of sandySoilTypes) {
        expect(calculateBulkDensity(10, soilType)).toBeCloseTo(1 / (10 * 0.02525 + 0.6541))
      }
    })
    ...
    it("should return a reasonable value for organic soils", () => {
      ...
      const calculatedDensity = calculateBulkDensity(organicMatterContent, soilType)
    ...
    it("should calculate different bulk densities for the same organic matter content but different soil types", () => {
      ...
      const sandySoilDensity = calculateBulkDensity(organicMatterContent, "dekzand")
      const nonSandySoilDensity = calculateBulkDensity(organicMatterContent, "rivierklei")
