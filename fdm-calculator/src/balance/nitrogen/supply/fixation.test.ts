...
describe("calculateNitrogenFixation", () => {
  it("should return 0 if no cultivations are provided", () => {
    ...
    const result = calculateNitrogenFixation(cultivations, cultivationDetailsMap)
  ...
  it("should calculate nitrogen fixation for a single cultivation", () => {
    ...
    expect(result.cultivations).toEqual([{ id: "cultivation1", value: new Decimal(50) }])
  })
  ...
  it("should throw an error if a cultivation has no details", () => {
    ...
    expect(() => calculateNitrogenFixation(cultivations, cultivationDetailsMap)).toThrowError(
