...
describe("calculateNitrogenRemovalByHarvests", () => {
  it("should calculate nitrogen removal for a single harvest with one analysis", () => {
    ...
    const result = calculateNitrogenRemovalByHarvests(cultivations, harvests, cultivationDetailsMap)
  ...
  it("should throw an error if a harvest has no corresponding cultivation", () => {
    ...
    expect(() =>
      calculateNitrogenRemovalByHarvests(cultivations, harvests, cultivationDetailsMap),
    ).toThrowError(
  ...
  it("should throw an error if a cultivation has no details", () => {
    ...
    expect(() =>
      calculateNitrogenRemovalByHarvests(cultivations, harvests, cultivationDetailsMap),
    ).toThrowError("Cultivation catalogue1 has no corresponding cultivation in cultivationDetails")
  })
})
