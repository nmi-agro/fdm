...
describe("calculateNitrogenRemovalByResidue", () => {
  ...
  it("should return 0 if crop residues are left on the field", () => {
    ...
    const result = calculateNitrogenRemovalByResidue(cultivations, harvests, cultivationDetailsMap)
  ...
  it("should handle missing cultivation details and throw an error", () => {
    ...
    expect(() =>
      calculateNitrogenRemovalByResidue(cultivations, harvests, cultivationDetailsMap),
    ).toThrowError(
