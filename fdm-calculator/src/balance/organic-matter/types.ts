...
export type FieldInput = {
  ...
  field: Pick<Field, "b_id" | "b_centroid" | "b_area" | "b_start" | "b_end" | "b_bufferstrip">
  /** The list of cultivations that took place on the field. */
  cultivations: Pick<
    Cultivation,
    "b_lu" | "b_lu_name" | "b_lu_start" | "b_lu_end" | "b_lu_catalogue" | "m_cropresidue"
  >[]
  /** The list of soil analyses performed on the field. */
  soilAnalyses: Pick<
    SoilAnalysis,
    "a_id" | "b_sampling_date" | "a_som_loi" | "a_density_sa" | "b_soiltype_agr"
  >[]
