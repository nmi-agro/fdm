    ...
    const item: CatalogueFertilizerItem = {
      ...
      p_app_method_options:
        fertilizer.p_app_method_options === undefined
          ? null
          : (fertilizer.p_app_method_options.split("||") as ApplicationMethods[]),
      p_app_amount_unit:
        fertilizer.p_app_amount_unit === undefined
          ? "kg/ha"
          : (fertilizer.p_app_amount_unit as ApplicationUnits),
      p_ef_nh3: fertilizer.p_ef_nh3 === undefined ? null : fertilizer.p_ef_nh3,
      p_dm: fertilizer.p_dm === undefined ? null : fertilizer.p_dm,
      p_density: fertilizer.p_density === undefined ? null : fertilizer.p_density,
      ...
      p_no3_rt: fertilizer.p_no3_rt === undefined ? null : fertilizer.p_no3_rt,
      p_nh4_rt: fertilizer.p_nh4_rt === undefined ? null : fertilizer.p_nh4_rt,
      p_p_rt: fertilizer.p_p_rt === undefined ? null : fertilizer.p_p_rt,
      p_k_rt: fertilizer.p_k_rt === undefined ? null : fertilizer.p_k_rt,
      p_mg_rt: fertilizer.p_mg_rt === undefined ? null : fertilizer.p_mg_rt,
      p_ca_rt: fertilizer.p_ca_rt === undefined ? null : fertilizer.p_ca_rt,
      p_s_rt: fertilizer.p_s_rt === undefined ? null : fertilizer.p_s_rt,
      p_s_wc: null,
      p_cu_rt: fertilizer.p_cu_rt === undefined ? null : fertilizer.p_cu_rt,
      p_zn_rt: fertilizer.p_zn_rt === undefined ? null : fertilizer.p_zn_rt,
      p_na_rt: fertilizer.p_na_rt === undefined ? null : fertilizer.p_na_rt,
      p_si_rt: null,
      p_b_rt: fertilizer.p_b_rt === undefined ? null : fertilizer.p_b_rt,
      p_mn_rt: fertilizer.p_mn_rt === undefined ? null : fertilizer.p_mn_rt,
      p_ni_rt: null,
      p_fe_rt: null,
      p_mo_rt: fertilizer.p_mo_rt === undefined ? null : fertilizer.p_mo_rt,
      p_co_rt: fertilizer.p_co_rt === undefined ? null : fertilizer.p_co_rt,
      p_as_rt: null,
      p_cd_rt: null,
      p_cr_rt: null,
      p_cr_vi: null,
